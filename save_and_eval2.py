...
vid_long_all = extract_embd('long_s2_h125.txt')

vid_long = np.ascontiguousarray(vid_long_all[:, 2:])

print("total long embedding file\t", vid_long.shape[0])


# vid_long_all[vid_long_all[:,0]!=0].shape
...
########################## 更改代码处 ##########################
embedding_file_nm = 'short4_125.txt'
